...
export const MOCK_CONTRACTS: Contract[] = [
  ...
  },
  {
    ...
    activityLog: [
      ...
      {
        id: 'act-c2-2',
        action: 'Generated invoice ONEFM-2026-015',
        performedBy: 'Station Manager',
        timestamp: '2026-06-09T09:00:00.000Z',
        notes: 'June 2026 batch — GVL 2026 MAJOR (Apr–Jun), saved to shared invoice store',
      },
    ],
    ...
    invoices: [
      {
        invoiceNumber: 'ONEFM-2026-015',
        amount: 4957.3,
        dueDate: '2026-06-23',
        date: '2026-06-09',
        periodLabel: 'Apr 2026 – Jun 2026',
        status: 'draft',
      },
    ],
  },
