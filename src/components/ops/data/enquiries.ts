...
export const MOCK_ENQUIRIES: Enquiry[] = [
  ...
  },
  {
    ...
    email: 'marcus@autoprogeelong.com.au',
    phone: '0411 555 999',
    company: 'Auto Pro Geelong',
  ...
  },
  {
    ...
    source: 'sponsorship',
    name: 'Amara Okafor',
    email: 'amara@geelongwellness.com.au',
    phone: '0422 777 333',
    company: 'Geelong Wellness Centre',
  ...
  },
  {
    ...
    source: 'sponsorship',
    name: 'Priya Sharma',
    email: 'priya@bollygeelong.com.au',
    phone: '0433 111 888',
    company: 'BollyGeelong Dance Studio',
    subject: 'Cultural event sponsorship',
    message:
      'We are hosting the Geelong Bollywood Festival in August and would love ONE FM as our media partner.',
    status: 'proposal_sent',
    priority: 'high',
    assignedTo: 'Ricardo B',
    notes: [
  ...
  },
  {
    ...
    source: 'sponsorship',
    name: 'Tom Radley',
    email: 'tom@geelongfitnessfactory.com',
    phone: '0415 333 777',
    company: 'Geelong Fitness Factory',
  ...
  },
  {
    ...
    email: 'gary.phillips@geelongsc.com.au',
    phone: '0400 555 222',
    company: 'Geelong Soccer Club',
    subject: '2025 Season Broadcast Sponsorship',
    message:
      'GSC is looking to secure ONE FM as our official broadcast partner for the 2025 GVL season.',
    status: 'negotiating',
    priority: 'urgent',
    assignedTo: 'Ricardo B',
    notes: [
      {
        id: 'n9',
        text: 'Met with Gary at GSC clubhouse. Countered at $32k including naming rights.',
        author: 'Ricardo B',
  ...
  },
  {
    ...
    source: 'football',
    name: 'Anita Roberts',
    email: 'a.roberts@bellarinefc.org',
    phone: '0425 999 000',
    company: 'Bellarine Football Club',
  ...
  },
  {
    ...
    email: 'dean.k@surfcotigers.com',
    phone: '0418 444 555',
    company: 'Surf Coast Tigers',
    subject: 'Match day sponsorship',
    message: 'Surf Coast Tigers want to explore match-day sponsorship for our home games.',
    status: 'new',
    priority: 'medium',
    notes: [],
  ...
  },
  {
    ...
    source: 'football',
    name: 'Rachel Kim',
    email: 'rachel@newcombunited.com.au',
    phone: '0436 222 444',
    company: 'Newcomb United FC',
