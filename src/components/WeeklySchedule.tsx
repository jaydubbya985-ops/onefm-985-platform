...
import { useMelbourneClock } from '@/hooks/useMelbourneClock'
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {DAY_TABS.map((day) => (
          <button
            key={day.index}
            type="button"
            onClick={() => setPinnedDay(day.index === today ? null : day.index)}
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {slots.length === 0 ? (
            ...
            slots.map((slot, i) => {
              const nowOnGuide = isNowSlot(slot)
              ...
              return (
                <motion.li
                  ...
                  ref={nowOnGuide ? liveRowRef : undefined}
                  whileHover={{ x: 4 }}
                ...
                >
                  ...
                  <div
                    ...
                    style={{ backgroundColor: accentColor, width: nowOnGuide ? '4px' : '3px' }}
                  />
                  ...
                  <div className="flex-1 min-w-0 pl-4 sm:pl-0">
                    ...
                    {withLine ? (
                      <p className="font-body-small text-muted text-xs truncate">{withLine}</p>
                    ) : null}
                  </div>
                  <span
