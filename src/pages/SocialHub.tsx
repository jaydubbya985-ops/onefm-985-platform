...
const FEED_POSTS = [
  ...
  { platform: 'Facebook', image: '/assets/images/event-food-trucks.jpg', caption: 'Food trucks at a Shepparton community event — station archive. Listen on 98.5 FM. #Shepparton #GoulburnValley' },
