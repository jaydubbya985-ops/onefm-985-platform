...
const shows = [
  ...
  },
  {
    ...
    desc: "Music from across the decades with Johnny P — the hits that span generations, from Shepparton.",
    tag: "Music",
    icon: Music,
  },
  {
  ...
  },
  {
    ...
    time: "Thursday, 11pm",
    host: "Carlos Rock",
    desc: "Thursday late rock with Carlos Rock — hours from the station guide (fm985.com.au/guide).",
    tag: "Music",
    icon: Headset,
  },
  {
