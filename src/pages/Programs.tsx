...
const shows = [
  ...
  },
  {
    ...
    host: "James Manley",
    desc: "Community-focused afternoon programming. Local interviews and the issues that matter to the Goulburn Valley.",
    tag: "Community",
    icon: Headphones,
  },
  {
  ...
  },
  {
    ...
    host: "Edith",
    desc: "Filipino music and culture celebrating the Filipino community across the Goulburn Valley.",
    tag: "Multicultural",
    icon: Headset,
  },
  {
  ...
  },
  {
    ...
    time: "Wednesday, 11pm",
    host: "ONE FM",
    desc: "Arabic language music program for the Arabic-speaking community of the Goulburn Valley.",
    tag: "Multicultural",
    icon: Headset,
  },
  {
