  ...
  return (
    <section className="relative overflow-hidden px-6 md:px-12 lg:px-20 pt-24 pb-20 min-h-[88vh] flex flex-col justify-center">
      ...
      <div className="flex items-center gap-4 flex-wrap mb-4">
        ...
        <Link
          to="/listen"
          className="font-bold text-[12px] tracking-[0.12em] uppercase text-white/50 hover:text-white transition-colors"
        >
          Full player →
        </Link>
      </div>
      {error ? (
        <p className="mb-4 text-[14px] text-white/70 max-w-xl" role="alert">
          {error}{' '}
          <a
