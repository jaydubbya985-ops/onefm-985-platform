...
assert(src.includes('{host}'), 'Host must be visible on the Follow / Open SoundCloud pill')
assert(src.includes('flex-col'), 'Host sits under the label so overflow-hidden cannot clip it')
