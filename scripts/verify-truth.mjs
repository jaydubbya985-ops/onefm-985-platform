...
const FORBIDDEN = [
  ...
  { re: /country-fri/, why: 'Good Evening Country is Thursday 8–11pm in FULL_SCHEDULE — Friday 7–11pm is NIRS AFL' },
  { re: /regional-voice/, why: 'Do not invent a weekday 12–3 strip id that is not on FULL_SCHEDULE' },
]
