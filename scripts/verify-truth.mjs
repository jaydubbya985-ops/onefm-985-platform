...
if (
  !footer ||
  /24\/7/.test(footer.text) ||
  !footer.text.includes('FOOTER_VOICE_LINE')
) {
  hits.push('components/Footer.tsx: editorial line must use FOOTER_VOICE_LINE — not invent 24/7 uptime')
}
